...
public class PlayerMovement : MonoBehaviour
{
    ...
    [SerializeField] private AudioClip walkingClip3;
    [SerializeField] private float audioPlayDelay = 0.1f;
    ...
    void Audio()
    {
        if (audioCooldown > audioPlayDelay)
        {
            ...
            if (random == 0)
            {
                audio.clip = walkingClip1;
            }
            else if (random == 1)
            {
                audio.clip = walkingClip2;
            }
            else
            {
                audio.clip = walkingClip3;
            }
    ...
    public void ResetAudioCooldown()
    {
        audioCooldown = 0;
    }
